            ...
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <button type="submit" class="btn btn-primary" name="save" value="create">
                  <a href="create_pet_vet.html" class="link-light link-underline-opacity-0">Book your session with Vet Now</a>                 
                </button>
              </div>
            </div>
          </div>
...
echo "<table id='vetRecords' class='table table-bordered table-striped'>";
echo "<tr>
        <th>ID</th>
        <th>Pet Name</th>
        <th>Symptoms</th>
