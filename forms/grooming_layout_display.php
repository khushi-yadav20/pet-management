  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
      ...
      <main class="app-main">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-end">
                <button type="submit" class="btn btn-primary" name="save" value="create">
                  <a href="create_pet_grooming.html" class="link-light link-underline-opacity-0">Book Now for pet's grooming</a>                 
                </button>
              </div>
            </div>
          </div>
        ...
        <div class="container-fluid my-4">
          ...
          $sql = "SELECT id, owner_name, pet_name, pet_breed, service_type, 
                 ...
                 submission_date FROM pet_grooming";
          $result = $conn->query($sql);

          echo "<h2>Pet Grooming Service Records</h2>";
          echo "<table id='groomingRecords' class='table table-bordered table-striped'>";
          echo "<thead>
                  <tr>
                    <th>ID</th>
                    <th>Owner Name</th>
    ...
    <script>
      $(document).ready(function() {
        $('#groomingRecords').DataTable({
            lengthMenu: [[3, 5, 10, 15, -1], [3, 5, 10, 15, "All"]],
            pageLength: 10,
            order: [[9, 'desc']], // sort by submitted_at descending
            columnDefs: [
                { targets: [10], orderable: false } // disable sorting on Actions
            ]
        });
      });
